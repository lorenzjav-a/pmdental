    ...
    <div class="container-fluid px-4">
      ...
      <div id="navStatic" class="collapse navbar-collapse">
        <ul class="navbar-nav me-auto gap-lg-1">
          <li class="nav-item"><a class="nav-link active" href="patient-profile-masterlist.php">Patient Masterlist</a></li>
        </ul>
      ...
      <div class="col-12">
        <div class="card p-4 shadow-sm border-0 bg-white">
          <div class="mb-3">
            ...
            <p class="text-muted small mb-0">Browse complete client credentials and append clinical history notes.</p>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="patient-profile-masterlist.php" method="POST">
  ...
  <script>
    ...
    document.querySelectorAll('.view-pres-btn').forEach(btn => {
      btn.addEventListener('click', function() {
        ...
        fetch('patient-profile-masterlist.php?fetch_prescription_json=1&patient_id=' + patientId)
          .then(r => r.json())
          .then(data => {
            tbody.innerHTML = '';

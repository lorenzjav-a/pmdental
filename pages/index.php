            ...
            <div class="col-lg-7 mt-5 mt-lg-0 position-relative">
                <div class="row g-3 justify-content-center">
                    <div class="col-6 col-md-5 mt-5">
                        <div class="rounded-5 overflow-hidden shadow mb-3" style="border-radius: 40px !important;">
                    ...
                    <div class="col-6 col-md-5">
                        ...
                        <div class="rounded-5 overflow-hidden shadow" style="border-radius: 40px !important;">

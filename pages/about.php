...
<div class="container py-5 mt-5">
    ...
    <div class="row g-5">
        ...
        <div class="col-md-4 text-center">
            <img src="../images/dentist hams.jpg" class="img-fluid rounded-4 shadow" alt="PM Dental Clinic Interior">
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="p-4 rounded-5 shadow-sm text-center" style="background-color: #f2f2f2; min-height: 260px;">
